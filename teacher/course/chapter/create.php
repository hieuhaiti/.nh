        ...
        <div class="body-wrapper">
            <div class="body-wrapper__content row">
                <div class="col-3 bg-light">
                    ...
                    <a href=<?= abs_url('teacher/course/my_course.php') ?> class="return_page-text">View All Course</a>
                ...
                <div class="col-9">
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="row">
                            <h5>Chapter Title</h5>
                            <input name="chapter_title" class="form-control" type="text">
                        </div><br>
                        <input class="btn btn-success w-30" type="submit" value="Create" name="create_chapter"><br><br>
                    </form>
                    <!-- FORM PROCESS -->
                    <?php
                    if (isset($_POST['create_chapter'])) {
                        ...
                        $sql = "INSERT INTO `chapter`(`chapter_title`, `course_id`) 
                                VALUES ('$chapter_title', $current_course_id)";

                        // mysqli_query($conn, $sql);
                        excute($sql);
                        echo "<p>Create Success Chapter Title:<br> $chapter_title";
                    }
                    ?>
                </div>
            </div>
